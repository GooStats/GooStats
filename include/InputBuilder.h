...
class InputBuilder {
  public:
    ...
    virtual bool fillOptions(ConfigsetManager *configset,int argc,char **argv) = 0;
    virtual bool fillOptions(ConfigsetManager *configset,const std::string &configFileName) = 0;
