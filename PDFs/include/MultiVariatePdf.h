...
class MultiVariatePdf : public GooPdf {
  public:
    ...
    MultiVariatePdf(std::string n, MVLLType MVLLtype,Variable *mv_var,BinnedDataSet *data,const std::vector<BinnedDataSet*> &refs,const std::vector<GooPdf*> &pdf_0_,const std::vector<GooPdf*> &pdf_1_,const std::vector<Variable*> &rate_0_,const std::vector<Variable*> &rate_1_,int startbin_,int endbin_/*startbin<=bin<endbin*/,SumPdf *sumpdf_,double binVolume_ = 1) ;
