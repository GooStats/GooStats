...
class ResponseFunctionPdf : public GooPdf {
 ...
 private:
  void insertResponseFunctionAndNLPar(const std::vector<Variable *> &quenching_par,
                                      ...
                                      double feq);
  void chooseFunctionPtr(Variable *npe,
...
EXEC_TARGET fptype GetNL(fptype *evt, fptype *p, unsigned int *indices);
template <ResponseFunctionPdf::Mean type>
EXEC_TARGET fptype GetMean(fptype mu, fptype *p, unsigned int *indices);
template <ResponseFunctionPdf::RES res>
EXEC_TARGET fptype GetVariance(fptype mu, fptype *p, unsigned int *indices);
