...
template <ResponseFunctionPdf::NL nl,
          ResponseFunctionPdf::Mean type,
          ResponseFunctionPdf::RES res>  // type: normal, peak(gamma) or shifted(position)
EXEC_TARGET fptype device_npe_GeneralizedGamma(fptype* evt, fptype* p, unsigned int* indices) {
  ...
  const fptype moment_4 = (variance * variance * (2. + 3. / mu) + 4. * mu * mu * (variance - 2.) +
                           2. * mu * (6. * variance - 1) + (variance + mu * mu) * (variance + mu * mu));
  ...
  /* Finalize */
  const fptype ret =
      (EXP(LOG(2.) + alpha * LOG(beta) + LOG(Evis) * (2. * alpha - 1.) + -beta * Evis * Evis - ::lgamma(alpha)));
#ifdef RPF_CHECK
  ...
  if ((THREADIDX == 0) || (fabs(mu - Evis) < sqrt(variance) * 0.2))
    printf(
        "%d %.1lf <- %.1lf : (%.1lf %.3lf %.3lf) (%.3lf %.3lf %.3lf) (%.3lf) | (%lf %lf) (%lf %lf) (%lf %lf) -> %lf\n",
        THREADIDX,
        Evis,
        Eraw,
        ly,
...
EXEC_TARGET fptype device_npe_ModifiedGaussian(fptype* evt, fptype* p, unsigned int* indices) {
  ...
  if ((THREADIDX == 0) || (fabs(mu - Evis) < sqrt(variance) * 0.2))
    printf(
        "%d %.1lf <- %.1lf : (%.1lf %.3lf %.3lf) (%.3lf %.3lf %.3lf %.3lf) (%.3lf) | (%lf %lf %lf) (%lf %lf) -> %lf\n",
        THREADIDX,
        Evis,
        Eraw,
        /**/ ly,
...
MEM_DEVICE device_function_ptr ptr_to_npe_GeneralizedGamma_Mach4_normal =
    device_npe_GeneralizedGamma<ResponseFunctionPdf::NL::Mach4,
                                ResponseFunctionPdf::Mean::normal,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_GeneralizedGamma_Mach4_peak =
    device_npe_GeneralizedGamma<ResponseFunctionPdf::NL::Mach4,
                                ResponseFunctionPdf::Mean::peak,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_GeneralizedGamma_Mach4_shifted =
    device_npe_GeneralizedGamma<ResponseFunctionPdf::NL::Mach4,
                                ResponseFunctionPdf::Mean::shifted,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_GeneralizedGamma_Echidna_normal =
    device_npe_GeneralizedGamma<ResponseFunctionPdf::NL::Echidna,
                                ResponseFunctionPdf::Mean::normal,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_GeneralizedGamma_Echidna_peak =
    device_npe_GeneralizedGamma<ResponseFunctionPdf::NL::Echidna,
                                ResponseFunctionPdf::Mean::peak,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_GeneralizedGamma_Echidna_shifted =
    device_npe_GeneralizedGamma<ResponseFunctionPdf::NL::Echidna,
                                ResponseFunctionPdf::Mean::shifted,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_GeneralizedGamma_expPar_normal =
    device_npe_GeneralizedGamma<ResponseFunctionPdf::NL::expPar,
                                ResponseFunctionPdf::Mean::normal,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_GeneralizedGamma_expPar_peak =
    device_npe_GeneralizedGamma<ResponseFunctionPdf::NL::expPar,
                                ResponseFunctionPdf::Mean::peak,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_GeneralizedGamma_expPar_shifted =
    device_npe_GeneralizedGamma<ResponseFunctionPdf::NL::expPar,
                                ResponseFunctionPdf::Mean::shifted,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ModifiedGaussian_Mach4_normal =
    device_npe_ModifiedGaussian<ResponseFunctionPdf::NL::Mach4,
                                ResponseFunctionPdf::Mean::normal,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ModifiedGaussian_Mach4_peak =
    device_npe_ModifiedGaussian<ResponseFunctionPdf::NL::Mach4,
                                ResponseFunctionPdf::Mean::peak,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ModifiedGaussian_Mach4_shifted =
    device_npe_ModifiedGaussian<ResponseFunctionPdf::NL::Mach4,
                                ResponseFunctionPdf::Mean::shifted,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ModifiedGaussian_Echidna_normal =
    device_npe_ModifiedGaussian<ResponseFunctionPdf::NL::Echidna,
                                ResponseFunctionPdf::Mean::normal,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ModifiedGaussian_Echidna_peak =
    device_npe_ModifiedGaussian<ResponseFunctionPdf::NL::Echidna,
                                ResponseFunctionPdf::Mean::peak,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ModifiedGaussian_Echidna_shifted =
    device_npe_ModifiedGaussian<ResponseFunctionPdf::NL::Echidna,
                                ResponseFunctionPdf::Mean::shifted,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ModifiedGaussian_expPar_normal =
    device_npe_ModifiedGaussian<ResponseFunctionPdf::NL::expPar,
                                ResponseFunctionPdf::Mean::normal,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ModifiedGaussian_expPar_peak =
    device_npe_ModifiedGaussian<ResponseFunctionPdf::NL::expPar,
                                ResponseFunctionPdf::Mean::peak,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ModifiedGaussian_expPar_shifted =
    device_npe_ModifiedGaussian<ResponseFunctionPdf::NL::expPar,
                                ResponseFunctionPdf::Mean::shifted,
                                ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ScaledPoisson_Mach4_normal =
    device_npe_ScaledPoisson<ResponseFunctionPdf::NL::Mach4,
                             ResponseFunctionPdf::Mean::normal,
                             ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ScaledPoisson_Mach4_peak =
    device_npe_ScaledPoisson<ResponseFunctionPdf::NL::Mach4,
                             ResponseFunctionPdf::Mean::peak,
                             ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ScaledPoisson_Mach4_shifted =
    device_npe_ScaledPoisson<ResponseFunctionPdf::NL::Mach4,
                             ResponseFunctionPdf::Mean::shifted,
                             ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ScaledPoisson_Echidna_normal =
    device_npe_ScaledPoisson<ResponseFunctionPdf::NL::Echidna,
                             ResponseFunctionPdf::Mean::normal,
                             ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ScaledPoisson_Echidna_peak =
    device_npe_ScaledPoisson<ResponseFunctionPdf::NL::Echidna,
                             ResponseFunctionPdf::Mean::peak,
                             ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ScaledPoisson_Echidna_shifted =
    device_npe_ScaledPoisson<ResponseFunctionPdf::NL::Echidna,
                             ResponseFunctionPdf::Mean::shifted,
                             ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ScaledPoisson_expPar_normal =
    device_npe_ScaledPoisson<ResponseFunctionPdf::NL::expPar,
                             ResponseFunctionPdf::Mean::normal,
                             ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ScaledPoisson_expPar_peak =
    device_npe_ScaledPoisson<ResponseFunctionPdf::NL::expPar,
                             ResponseFunctionPdf::Mean::peak,
                             ResponseFunctionPdf::RES::charge>;
MEM_DEVICE device_function_ptr ptr_to_npe_ScaledPoisson_expPar_shifted =
    device_npe_ScaledPoisson<ResponseFunctionPdf::NL::expPar,
                             ResponseFunctionPdf::Mean::shifted,
                             ResponseFunctionPdf::RES::charge>;
