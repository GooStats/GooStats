...
__host__ RatioPullPdf::RatioPullPdf(std::string n, Variable* var1, Variable* var2, fptype m, fptype s)
    : DataPdf(nullptr, n), index_v1(registerParameter(var1)), index_v2(registerParameter(var2)), data(m), sigma(s) {}
...
void RatioPullPdf::cache() { data_backup = data; }
void RatioPullPdf::restore() { data = data_backup; }
